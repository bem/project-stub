      ...
      content : [
        {
          ...
          content: [
            ...
            },
            {
              ...
              content: 'Мы&nbsp;вынесли блок .text с&nbsp;модификаторами на&nbsp;цвет размер, регистр, жирность<br> и&nbsp;межбуквенный интервал. Их&nbsp;можно использовать в&nbsp;различных комбинациях. <br>Манипулируя достаточно небольшим количеством комбинаций мы&nbsp;получаем<br/> все необходимые вариации текста.'
            },
            {
              elem : 'section',
              content : [
